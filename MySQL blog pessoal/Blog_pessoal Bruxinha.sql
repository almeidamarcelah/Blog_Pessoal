...
-- -----------------------------------------------------
-- Table `blog_pessoal`.`tb_bruxas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blog_pessoal`.`tb_bruxas` (
...
CREATE TABLE IF NOT EXISTS `blog_pessoal`.`tb_postagens` (
  ...
  `data` DATE NOT NULL,
  `bruxa_id` BIGINT NULL,
  `usuarios_id` BIGINT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tb_postagens_tb_bruxa_idx` (`bruxa_id` ASC) VISIBLE,
  INDEX `fk_tb_postagens_tb_usuarios1_idx` (`usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_postagens_tb_bruxa`
    FOREIGN KEY (`bruxa_id`)
    REFERENCES `blog_pessoal`.`tb_bruxas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
